...
(define (script-fu-retro-effect 	img
	...
	(let* (
		...
		(set! tint-layer (car (gimp-layer-new img img-width img-height RGBA-IMAGE "Tint" 20 DIFFERENCE-MODE)))
...
; This script will appear as a filter named "Retro Effect" in the Filters > Photography block
